...
lines contains the name and marks obtained by that student separated by a space. The final line contains the name 
...
print("%.2f" %(sum(student_marks[query_name])/len(student_marks[query_name]))) #imp line
